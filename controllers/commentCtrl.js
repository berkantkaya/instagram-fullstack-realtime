...
likeComment:async(req,res)=>{
    try {
       ...
       await Comments.findByIdAndUpdate({_id:req.params.id},{$push:{likes:req.user._id}},{new:true})  
...
unLikeComment:async(req,res)=>{
    try {
       ...
       await Comments.findByIdAndUpdate({_id:req.params.id},{$pull:{likes:req.user._id}},{new:true})  
